...
const config = {
  title: "AiRobot's site",
  tagline: 'Dinosaurs are cool',
  favicon: 'img/favicon.ico',

  // Set the production url of your site here
  url: 'https://airoboth.github.io',
  ...
  organizationName: 'airoboth', // Usually your GitHub org/user name.
  projectName: 'tech-site', // Usually your repo name.
